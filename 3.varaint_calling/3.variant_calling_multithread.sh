...
### This is an optional version of the script which runs
### the call over multiple threads, speeding up the process.
### By defualt 20 threads are used. Set this value based on
### the requirements of your server/computing resources.
